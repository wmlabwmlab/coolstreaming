 ...
 * @version $Rev: 575603 $, $Date: 2007-09-14 19:04:45 +0900 (금, 14  9월 2007) $
 */
public class SimPipeSessionImpl extends BaseIoSession {
     ...
     */
    public SimPipeSessionImpl( IoService service, IoServiceConfig serviceConfig,
                              IoServiceListenerSupport serviceListeners,
                              SocketAddress localAddress, IoHandler handler, SimPipe remoteEntry ) {
        ...
        this.filterChain = new SimPipeFilterChain(this);
        this.pendingDataQueue = new LinkedBlockingQueue<Object>();

        remoteSession = new SimPipeSessionImpl(this, remoteEntry);
    }

    /*
     * Constructor for server-side session.
     */
    private SimPipeSessionImpl(SimPipeSessionImpl remoteSession, SimPipe entry) {
