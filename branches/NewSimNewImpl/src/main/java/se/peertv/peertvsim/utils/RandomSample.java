/**
 * =============================================== 
*  File     : $Id: RandomSample.java,v 1.1 2007/05/29 10:04:49 sameh Exp $
*  Authors  : Sameh El-Ansary & Mohammed El-Beltagy (sameh,elbeltagy@sics.se)
*  Version  :$Revision: 1.1 $
*  Tag	  : $Name:  $
*  Last edited by   : $Author: sameh $
*  Last updated:    $Date: 2007/05/29 10:04:49 $
*===============================================
 */
/*
...
public class RandomSample
{
  ...
  public RandomSample(long N, int n,int seed)
	{
	  this(N, n, new Random(seed));
	}
  ...
  public Set<Number>  nextSampleAsAset()
  {
     HashSet<Number> sample  = new HashSet<Number> (n);
    //int i = 0;
  ...
  {
    RandomSample rs = new RandomSample(10, 6);
